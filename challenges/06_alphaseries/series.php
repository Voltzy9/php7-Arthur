...
$show = showDetails($shows);
if (!isset($_GET['slug'])) {
    header('Location: aleatoire.php');
}
?>
<!doctype html>
<html lang="fr">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 d-none d-md-block">
                    <img src="<?= $show['images']['poster'] ?>" alt="Poster de Rick and Morty" class="img-thumbnail">
                </div>
                        ...
                        <div class="card-body">
                            <h4 class="card-title">
                                ...
                                <span class="stars text-info" data-toggle="tooltip" data-placement="top" title="<?= round($show['statistics']['rating'], 2)?>">
                                    <?= ratingStars($show['statistics']['rating']) ?>
                                </span>
                            </h4>
